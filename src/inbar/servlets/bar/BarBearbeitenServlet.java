...
public class BarBearbeitenServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		//Falls der User nicht eingeloggt ist wird er auf die nicht Eingeloggt Seite verwiesen weil selfUser dann NULL zurÃ¼ck gibt
						...
						+ "plz = ?, ort = ?, barmail = ?, bbeschreibung = ?, mbeschreibung = ?, lbeschreibung = ? WHERE barid = ? "))
		{
			...
			if (userZuBar.first()) { //falls eine Zuordnung von userid und barid existiert ausfÃ¼hren
